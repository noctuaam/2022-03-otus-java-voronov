...
import ru.voronov.core.repository.DataTemplateHibernate;
import ru.voronov.core.repository.HibernateUtils;
import ru.voronov.core.sessionmanager.TransactionManagerHibernate;
import ru.voronov.crm.dbmigrations.MigrationsExecutorFlyway;
import ru.voronov.crm.model.Client;
import ru.voronov.crm.service.DBServiceClient;
import ru.voronov.crm.service.DbServiceClientImpl;

import static ru.voronov.demo.DbServiceDemo.HIBERNATE_CFG_FILE;
