...
class CustomerTest {
    ...
    @Test
    @DisplayName("Проверяем, что класс homework.Customer не сломан")
    void setterCustomerTest() {
        ...
        //then
        AssertionsForClassTypes.assertThat(customer.getName()).isEqualTo(expectedName);
    }

    @Test
    @DisplayName("Объект homework.Customer как ключ в карте")
    ...
    void scoreSortingTest() {
        ...
        //then
        AssertionsForClassTypes.assertThat(smallestScore.getKey()).isEqualTo(customer2);
        ...
        //then
        AssertionsForClassTypes.assertThat(middleScore.getKey()).isEqualTo(customer1);
        ...
        //then
        AssertionsForClassTypes.assertThat(biggestScore.getKey()).isEqualTo(customer3);
    ...
    void mutationTest() {
        ...
        //then
        AssertionsForClassTypes.assertThat(customerService.getSmallest().getKey().getName()).isEqualTo(customer2.getName());
    }
    ...
    void reverseOrderTest() {
        ...
        //then
        AssertionsForClassTypes.assertThat(customerLast).usingRecursiveComparison().isEqualTo(customer3);

        //when
        Customer customerMiddle = customerReverseOrder.take();
        //then
        AssertionsForClassTypes.assertThat(customerMiddle).usingRecursiveComparison().isEqualTo(customer2);

        //when
        Customer customerFirst = customerReverseOrder.take();
        //then
        AssertionsForClassTypes.assertThat(customerFirst).usingRecursiveComparison().isEqualTo(customer1);
    }
}