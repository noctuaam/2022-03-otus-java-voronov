...
public class WebServerImpl implements WebServer {
    ...
    public WebServerImpl(int port, TemplateProcessor templateProcessor, UserAuthService authService, DBServiceClient dbServiceClient) {
    ...
    private ServletContextHandler createServletContextHandler() {
        ...
        //servletContextHandler.addServlet(new ServletHolder(new UsersApiServlet(userDao, gson)), "/api/client/*");
        return servletContextHandler;
    }
}
